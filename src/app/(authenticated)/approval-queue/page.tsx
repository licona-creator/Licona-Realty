        ...
        <div className="flex gap-1.5 overflow-x-auto pb-2 mb-4 scrollbar-hide">
          <button
            ...
            className={`px-3 py-1.5 rounded-[8px] text-xs font-montserrat font-medium whitespace-nowrap transition-all
              ${filter === 'all' ? 'bg-navy text-gold' : 'bg-dark-card text-white/50 border border-gold/15'}`}
          >
            All ({items.length})
          </button>
          {uniqueTypes.map((type) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-[8px] text-xs font-montserrat font-medium whitespace-nowrap transition-all
                ${filter === type ? 'bg-navy text-gold' : 'bg-dark-card text-white/50 border border-gold/15'}`}
            >
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-montserrat font-semibold text-white/70 uppercase tracking-wider">
                ...
                {/* Subject */}
                {item.subject && (
                  <p className="text-sm font-montserrat font-semibold text-white mb-2">
                    {item.subject}
                  </p>
                )}
                ...
                {isEditing ? (
                  ...
                  <>
                    <div className="bg-navy/30 rounded-[8px] p-3 mb-3 border border-gold/15">
      ...
      {!loading && filteredItems.length === 0 && (
        ...
        >
          <Card className="!p-8 text-center">
            ...
            <p className="text-xs text-white/30 font-inter mt-4">
