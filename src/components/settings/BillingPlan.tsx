  ...
  return (
    <div>
      <div className="flex justify-between text-xs mb-1">
        ...
        <span className={`font-inter ${isWarning ? 'text-amber-600 font-semibold' : 'text-white/50'}`}>
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-white">Current Plan</h3>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div>
            <p className="text-xs text-white/50 font-inter">Plan</p>
            <p className="text-sm font-montserrat font-semibold text-white">Starter</p>
          </div>
          <div>
            <p className="text-xs text-white/50 font-inter">Monthly Cost</p>
            <p className="text-sm font-montserrat font-semibold text-white">$0</p>
            <p className="text-[10px] text-white/30 font-inter">Free tier</p>
          </div>
          <div>
            <p className="text-xs text-white/50 font-inter">Renewal</p>
            <p className="text-sm font-montserrat font-semibold text-white">N/A</p>
          </div>
          <div>
            <p className="text-xs text-white/50 font-inter">Payment Method</p>
            <p className="text-sm font-montserrat font-semibold text-white/40">None on file</p>
          </div>
        </div>
      </Card>
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-white">Infrastructure Costs</h3>
        </div>

        {/* Supabase */}
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-montserrat font-semibold text-white">Supabase</h4>
        ...
        <div className="mb-6 pt-4 border-t border-gold/15">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-montserrat font-semibold text-white">Vercel</h4>
        ...
        <div className="mb-6 pt-4 border-t border-gold/15">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-montserrat font-semibold text-white">Google APIs</h4>
        ...
        <div className="pt-4 border-t border-gold/15">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-montserrat font-semibold text-white">DocuSign</h4>
      ...
      {/* Upgrade Prompts */}
      <Card>
        <h3 className="text-base font-montserrat font-semibold text-white mb-4">Upgrade Alerts</h3>
        <div className="space-y-3">
          <div className="flex items-start gap-3 p-3 rounded-[8px] bg-white/5">
            <div className="w-2 h-2 rounded-full bg-green-500 mt-1.5 flex-shrink-0" />
            <div>
              <p className="text-sm text-white font-inter">Supabase</p>
              <p className="text-xs text-white/50 font-inter">
          ...
          <div className="flex items-start gap-3 p-3 rounded-[8px] bg-white/5">
            <div className="w-2 h-2 rounded-full bg-green-500 mt-1.5 flex-shrink-0" />
            <div>
              <p className="text-sm text-white font-inter">Google Maps</p>
              <p className="text-xs text-white/50 font-inter">
          ...
          <div className="flex items-start gap-3 p-3 rounded-[8px] bg-amber-50 border border-amber-200">
            ...
            <div>
              <p className="text-sm text-white font-inter">DocuSign</p>
