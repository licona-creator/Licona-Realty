...
function MaskedField({ label, value, sensitive = false }: { label: string; value: string; sensitive?: boolean }) {
  const [revealed, setRevealed] = useState(false);

  return (
    <div className="flex items-center gap-2">
      <span className="text-xs text-text/50 font-inter w-28 flex-shrink-0">{label}:</span>
      <code className="text-xs text-text/70 font-mono flex-1 truncate">
        {revealed ? value : '••••••••••••••••'}
      </code>
      <button
...
function SetupStep({ number, text }: { number: number; text: string }) {
  return (
    <li className="flex gap-3">
      ...
      <span className="text-sm text-text/70 font-inter">{text}</span>
    </li>
  );
}
...
function StatusRow({ label, ok, detail }: { label: string; ok: boolean; detail?: string }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-xs text-text/60 font-inter">{label}</span>
      {detail && <span className="text-[10px] text-text/40 font-inter ml-auto">{detail}</span>}
    </div>
  );
}
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div>
        ...
        <p className="text-sm text-text/50 font-inter mt-1">
          ...
          Green means verified. No fake checkmarks.
        </p>
      </div>
      ...
      >
        <div className="space-y-4">
          ...
          <MaskedField label="Anon Key" value="eyJhbGci...masked" sensitive />
          <p className="text-[10px] text-text/30 font-inter">
            Service role key is server-side only and never displayed in settings.
          </p>

          <div className="border-t border-gold-15 pt-4">
            <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Table Health Check</h5>
          ...
          <div className="border-t border-gold-15 pt-4">
            <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Backup Status</h5>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="border-t border-gold-15 pt-4">
            <h5 className="text-xs font-montserrat font-semibold text-text mb-3">Setup Instructions</h5>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs text-text/50 font-inter">Sync direction:</span>
              <select className="text-xs font-inter rounded-[8px] border border-gold-15 bg-surface px-2 py-1">
          ...
          <div className="flex gap-2">
            ...
            <Button size="sm" variant="ghost">Send Test Event</Button>
          </div>
        </div>
      </IntegrationCard>
      ...
      >
        <div className="space-y-4">
          <MaskedField label="API Key" value="AIzaSy...masked" sensitive />

          <div className="border-t border-gold-15 pt-4">
            <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Enabled APIs</h5>
          ...
          <div className="border-t border-gold-15 pt-4">
            <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Monthly Usage</h5>
            <div className="space-y-2">
              <div>
                <div className="flex justify-between text-xs text-text/50 font-inter mb-1">
      ...
      <IntegrationCard
        ...
        onTest={async () => { await new Promise(r => setTimeout(r, 1500)); }}
        statusDetails={
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs text-text/50 font-inter">Environment:</span>
            <div className="flex rounded-[8px] border border-gold-15 overflow-hidden">
              <button
                className={`px-3 py-1.5 text-xs font-montserrat font-medium transition-colors ${
                  docusignEnv === 'sandbox' ? 'bg-gold text-navy' : 'text-text/50 hover:bg-surface'
                }`}
              ...
              <button
                className={`px-3 py-1.5 text-xs font-montserrat font-medium transition-colors ${
                  docusignEnv === 'production' ? 'bg-gold text-navy' : 'text-text/50 hover:bg-surface'
                }`}
                onClick={() => {
          ...
          <div className="space-y-2">
            <MaskedField label="Integration Key" value="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" sensitive />
            <MaskedField label="User ID" value="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" sensitive />
            <MaskedField label="Account ID" value="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" sensitive />
          </div>

          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="text-xs text-text/50 font-inter w-28">RSA Private Key:</span>
              <Button size="sm" variant="ghost">Upload RSA Key</Button>
            </div>
          </div>

          <div className="border-t border-gold-15 pt-4 space-y-2">
            <h5 className="text-xs font-montserrat font-semibold text-text">Webhook Configuration</h5>
            <div className="flex items-center gap-2 bg-surface rounded-[8px] px-3 py-2">
              <code className="text-xs text-text/60 font-mono flex-1 truncate">
            ...
            <MaskedField label="HMAC Secret" value="hmac-xxxxxxxxxxxx" sensitive />
          </div>
          ...
          <div className="border-t border-gold-15 pt-4">
            <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Production Upgrade</h5>
            <p className="text-xs text-text/50 font-inter mb-2">
      ...
      >
        <div className="space-y-4">
          {canvaStatus === 'not_submitted' && (
            <>
              <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Setup Guide</h5>
              <ol className="space-y-2">
            ...
            <>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="text-text/50 font-inter">Submission status:</span>
                  <span className="text-blue-600 font-inter">Under Review</span>
                </div>
              </div>
              <div className="flex gap-2">
                <a
                ...
                <Button
                  size="sm"
                  variant="accent"
                  onClick={() => setCanvaStatus('approved')}
                >
                  Mark as Approved
                </Button>
              </div>
          ...
          {canvaStatus === 'approved' && (
            <>
              <MaskedField label="Client ID" value="canva-client-xxxxx" sensitive />
              <MaskedField label="Client Secret" value="canva-secret-xxxxx" sensitive />
              <div className="flex gap-2">
                <Button variant="accent" size="sm">Connect Canva Account</Button>
                <Button size="sm" variant="ghost">Test Template Open</Button>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-text/50 font-inter">Brand kit sync:</span>
        ...
        <div className="space-y-4">
          {metaStatus === 'not_submitted' && (
            <>
              ...
              <div className="bg-surface rounded-[8px] p-3">
                <p className="text-xs font-montserrat font-semibold text-text mb-2">Required Permissions</p>
                <div className="grid grid-cols-2 gap-1">
                  {[
                    ...
                    <code key={p} className="text-[10px] text-text/60 font-mono">{p}</code>
                  ))}
                </div>
              </div>
          ...
          {metaStatus === 'pending' && (
            <>
              ...
              <div className="flex gap-2">
                <Button size="sm" variant="ghost">Connect Test Account</Button>
                <Button
                  size="sm"
                  variant="accent"
                  onClick={() => setMetaStatus('approved')}
                >
                  Mark as Approved
                </Button>
              </div>
          ...
          {metaStatus === 'approved' && (
            <>
              <MaskedField label="App ID" value="meta-app-xxxxx" sensitive />
              <MaskedField label="App Secret" value="meta-secret-xxxxx" sensitive />
              ...
              <div className="border-t border-gold-15 pt-4">
                <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Webhook URL</h5>
                <div className="flex items-center gap-2 bg-surface rounded-[8px] px-3 py-2">
                  <code className="text-xs text-text/60 font-mono flex-1 truncate">
              ...
              <div className="flex gap-2">
                <Button size="sm" variant="ghost">Test Webhook</Button>
                <Button size="sm" variant="ghost">Test Post</Button>
              </div>
            </>
          )}
        </div>
      ...
      >
        <div className="space-y-4">
          ...
          <MaskedField label="Webhook Secret" value="whsec-xxxxxxxxxxxx" sensitive />

          <div className="border-t border-gold-15 pt-4">
            <h5 className="text-xs font-montserrat font-semibold text-text mb-2">Embed Codes</h5>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={embed.label} className="bg-surface rounded-[8px] p-3">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-montserrat font-semibold text-text">{embed.label}</span>
                  ...
                  <code className="text-[10px] text-text/40 font-mono block truncate">
          ...
          <div className="border-t border-gold-15 pt-4">
            ...
            <ol className="space-y-2">
              ...
              <SetupStep number={5} text='Click "Test Webhook" above to verify the connection' />
            </ol>
          </div>
