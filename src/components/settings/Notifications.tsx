    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-white">Push Notifications</h3>
        </div>
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-white">Email Notifications</h3>
        </div>
        <div className="space-y-4">
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-white">Morning Briefing Configuration</h3>
        </div>
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <label className="text-sm text-white/70 font-inter w-52">Approval digest notification:</label>
            <input
              type="time"
          ...
          <div className="flex items-center gap-4">
            <label className="text-sm text-white/70 font-inter w-52">Weekly health report day:</label>
            <select
          ...
          <div className="flex items-center gap-4">
            <label className="text-sm text-white/70 font-inter w-52">Weekly health report time:</label>
            <input
              type="time"
