    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-text">Default Language per Track</h3>
        </div>
        <div className="space-y-3">
          {TRACKS.map((track) => (
            <div key={track} className="flex items-center gap-4">
              <span className="text-sm text-text/70 font-inter w-24">{track}:</span>
              <select
                value={languages[track]}
                onChange={(e) => setLanguages({ ...languages, [track]: e.target.value })}
                className="text-sm font-inter rounded-[8px] border border-gold-15 bg-surface px-3 py-1.5 flex-1 max-w-xs"
              >
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-text">Default Tone per Track</h3>
        </div>
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-text">Campaign Timing</h3>
        </div>
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <label className="text-sm text-text/70 font-inter w-52">Default send time:</label>
            <input
              type="time"
            ...
            />
            <span className="text-xs text-text/40 font-inter">local time</span>
          </div>
          ...
          <div className="border-t border-gold-15 pt-4">
            ...
            {respectQuietHours && (
              <div className="flex items-center gap-3 mt-3 ml-13 pl-[52px]">
                <span className="text-xs text-text/50 font-inter">From</span>
                <input
                  type="time"
                  value={quietStart}
                  onChange={(e) => setQuietStart(e.target.value)}
                  className="text-xs font-inter rounded-[8px] border border-gold-15 bg-surface px-2 py-1"
                />
                <span className="text-xs text-text/50 font-inter">to</span>
                <input
                  type="time"
                  value={quietEnd}
      ...
      <Card>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h3 className="text-base font-montserrat font-semibold text-text">Voice Engine Preferences</h3>
        </div>
        <div className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-sm text-text/70 font-inter">Voice accuracy threshold</label>
